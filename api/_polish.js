...
- tagLabels: tags에 넣은 태그 각각에 대해, 방문자에게 보여줄 짧은 표시 이름을 한국어/영어/중국어로 하나씩 주세요
  (예: 태그가 wechat_recruit면 ko: "위챗 모집", en: "WeChat Recruiting", zh: "微信招募"). 기존 태그를 재사용한 경우에도
  넣어주세요(어차피 화면에는 안 쓰이니 상관없습니다) — 새 태그일 때만 실제로 쓰입니다.`;
...
const TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      tagLabels: {
        type: 'array',
        description: 'tags 각각의 표시 이름(3개 언어)',
        items: {
          type: 'object',
          properties: {
