...
const DATA = {
  ...
  nodes: [
    ...
    { id: 'malaria', label: '말라리아', type: 'wildcard', status: 'told',
      story: '포트모르즈비에선 말라리아가 흔했고, 삶과 죽음이 가까운 곳이었다. 언젠가 한 동료가 아이의 약값을 빌리러 왔던 것도 같다. 내가 어떻게 했는지, 그 뒤에 무슨 일이 있었는지는 사실과 기억과 상상 사이 어딘가에 놓여 있다. 다만 그런 순간들이 — 실제였든 그럴 수도 있었든 — 내가 상식이라 부르던 것들을 영영 바꿔놓았다.',
  ...
  openQuestions: [
    { node: 'png', q: '파푸아뉴기니 그 시절의 하루하루는 어떤 모습이었나요? 아침에 눈을 뜨면 무엇이 보였나요?' },
    { node: 'vienna', q: '혼자 비엔나 지사를 세울 때 가장 무서웠던 순간은 언제였나요?' },
    { node: 'salt', q: '히말라야 암염을 처음 수입하기로 마음먹은 계기는 무엇이었나요?' },
  ],
};
