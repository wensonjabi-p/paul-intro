...
const DATA = {
  ...
  nodes: [
    ...
    { id: 'prague', label: '프라하', type: 'place', era: '2005–2007', status: 'told',
    ...
    { id: 'ireland', label: '아일랜드', type: 'place', era: '1996 무렵', status: 'told',
    ...
    { id: 'salt', label: '소금', type: 'wildcard', status: 'told',
    ...
    { id: 'malaria', label: '말라리아', type: 'wildcard', status: 'told',
