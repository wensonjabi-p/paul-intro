# Configure Cursor BYOK for Kimi (Moonshot) on Windows (VPN OFF)
# Usage: .\scripts\configure-cursor-byok-kimi.ps1
...
$BackupDb = "$StateDb.bak-byok-kimi"
